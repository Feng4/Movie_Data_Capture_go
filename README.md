...
```bash
# 克隆仓库
git clone https://github.com/Feng4/movie-data-capture-go.git
...
从 [Releases](https://github.com/Feng4/movie-data-capture-go/releases) 页面下载适合你系统的预编译二进制文件。
...
1. **报告问题**: 在 [Issues](https://github.com/yourusername/movie-data-capture-go/issues) 中报告 Bug
2. **功能建议**: 提出新功能想法
...
```bash
# 克隆仓库
git clone https://github.com/yourusername/movie-data-capture-go.git
cd movie-data-capture-go
...
- 🐛 问题反馈: [GitHub Issues](https://github.com/Feng4/movie-data-capture-go/issues)
